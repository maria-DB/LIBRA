				...
				<div class="row">
					<div class="col-12">
						<div class="header__content">
							<!-- header logo -->
							<a href="{{ route('books') }}" class="header__logo">
							...
							<ul class="header__nav">
								...
								<li class="header__nav-item">
									<a class="dropdown-toggle header__nav-link" href="{{ route('books') }}" role="button" id="dropdownMenuHome" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
	...
	<section class="home">
		...
		<div class="container">
			<div class="row" id="popularBooks">
				<div class="col-12">
					<h1 class="home__title"><b>POPULAR BOOKS</b> BY THE USER</h1>
